...
def generate_words(image_name, score_bbox, image,crop_dir):
...
def crop_bound_images(csv_path, test_folder,crop_dir):
  # Create the crop dir
  ...
  for image_num in range(data.shape[0]):
    ...
    generate_words(image_name, score_bbox, image,crop_dir)